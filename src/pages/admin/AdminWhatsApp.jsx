  ...
  return (
    <div className="admin-panel">
      ...
      {serverReachable && !connected && checkedOnce && (
        <div className="admin-wa-card" style={{ background: 'var(--ivory)', border: '1px solid rgba(13, 58, 36,0.08)', borderRadius: '2px', padding: '28px', textAlign: 'center' }}>
          {!qr && !generating && (
            <>
          ...
          {qr && (
            <>
              ...
              <img src={qr} alt="WhatsApp QR code" style={{ width: '260px', maxWidth: '100%', height: 'auto', border: '8px solid white', borderRadius: '4px', boxShadow: '0 4px 16px rgba(13, 58, 36,0.12)' }} />
