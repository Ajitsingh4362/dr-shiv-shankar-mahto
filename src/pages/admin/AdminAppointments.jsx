...
export default function AdminAppointments() {
  ...
  async function updateStatus(appt, status) {
    ...
    if (status === 'confirmed') {
      ...
      const msg = `Hi ${appt.name}, this is Mahto Clinic confirming your appointment with Dr. Shiv Shankar Mahto for ${appt.service || 'consultation'} on ${dateStr}${timeStr}. Looking forward to seeing you!${WHATSAPP_FOOTER}`
