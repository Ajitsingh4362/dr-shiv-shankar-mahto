...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--navy-900)', borderTop: '1px solid rgba(13, 148, 136,0.12)', padding: '60px 0 24px' }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', marginBottom: '48px' }}>
          ...
          <div>
            ...
            <div style={{ marginTop: '20px', display: 'flex', gap: '12px' }}>
              <a href="https://wa.me/918987367274" target="_blank" rel="noopener noreferrer"
                style={{ width: '36px', height: '36px', borderRadius: '2px', background: 'rgba(13, 148, 136,0.1)', border: '1px solid rgba(13, 148, 136,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'var(--transition)' }}
          ...
          <div>
            ...
            {[
              {to:'/',l:'Home'},
              {to:'/about',l:'About Dr. Shiv Shankar Mahto'},
