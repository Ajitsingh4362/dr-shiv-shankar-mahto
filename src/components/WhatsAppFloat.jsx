...
export default function WhatsAppFloat() {
  ...
  return (
    <a href={`https://wa.me/${phone}?text=${msg}`} target="_blank" rel="noopener noreferrer"
      ...
      style={{ position: 'fixed', bottom: '28px', right: '28px', zIndex: 998, display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}
      ...
      <div style={{
        ...
        transition: 'var(--transition)', animation: 'pulse-gold 3s infinite',
      }}>
